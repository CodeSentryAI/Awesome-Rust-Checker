...
| [soteria-rust](https://github.com/soteria-tools/soteria) | Soteria is a library for writing efficient symbolic interpreters directly in OCaml. The core library is just a small toolbox that we use for writing a set of analyses, currently for C and Rust | ULLBC (gen by Obol or Charon) | Memory safety, Panic, Aliasing & UB | Symbolic Execution | 2026-08-18 |
| [mir-semantics](https://github.com/runtimeverification/mir-semantics) | A model of the semantics of Rust's Stable MIR in K to enable symbolic execution of Rust programs and proofs of program properties | StableMIR, K | - | Symbolic Execution | 2026-06-25 |
